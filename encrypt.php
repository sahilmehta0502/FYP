...
<html lang="en">
	...
	<body style="background: #3e4144;color:white;">
	<div class="topnav">
	<a href="nav.php" style="color:white;">HOME</a>&nbsp &nbsp &nbsp
	<a class="active" href="encrypt.php" style="color:white;">ENC/DEC</a>&nbsp &nbsp &nbsp
	<a href="index.php" style="color:white;">UPLOAD</a>&nbsp &nbsp &nbsp
	<a href="downloadtry.php" style="color:white;">DOWNLOAD</a>&nbsp &nbsp &nbsp
	<a href="logout.php" style="float:right;color:white;">LOGOUT</a>&nbsp &nbsp &nbsp
	</div>
		<div class=container>
		...
		<div class="container" id=divEncryptfile>
			<h2 style="color:#55a1ff;">Encrypt a File</h2><br><br>
			...
			<div>
				<div class=dropzone id="encdropzone" ondrop="drop_handler(event);" ondragover="dragover_handler(event);" ondragend="dragend_handler(event);">
					<p>Drag and drop the file to be encrypted into this dropzone, or click <a class="try" onclick=javascript:encfileElem.click();>here</a> to select file.</p>
